    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Dental Clinic System</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('doctor.Bio')}}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('doctor.Appointments')}}">
                    <i class="fa-solid fa-arrow-right-from-bracket"></i>
                    <span>مواعيد العمل</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{route('doctor.BookedAppointments')}}">
                    <i class="fa-regular fa-clock"></i>
                    <span>المواعيد المحجوزة</span></a>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{asset('DashBoardAssets/img/undraw_profile_1.svg')}}"
                                            alt="...">
                        ...
                        <img src="{{asset('storage/'. Auth::user()->doctor->img)}}" width="25" height="25">

                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="{{route('doctor.logout')}}" data-toggle="modal" data-target="#logoutModal">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Dental Clinic System 2026</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
