...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('patient.Bio')}}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('patient.Bio')}}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('patient.getBookedAppointment') }}">
